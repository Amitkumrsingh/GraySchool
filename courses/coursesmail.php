...
//$headers->AddAttachment( $file_to_attach , 'aboutus.jpg' );
  ...
  //	$file_to_attach = 'images/';
		...
		$cc = '';
		$subject = 'Course Details From Grayschool';
...
<tr align="center">
 <td colspan="2" align="center" valign="top" style="color:#FF0000"><U><strong>Course Details from Grayschool</strong></U></td>
  </tr>					  <tr > 
					  ...
					  <tr> 
						<td align="left" valign="top"><div align="right"><strong>Phone Number: 
							</strong></div></td>
						<td align="left" valign="top" width="259"> 
						  '.$_POST['phone'].'
						 </td>
